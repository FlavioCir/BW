...
abstract public class Mezzo {
	...
	public String toString() {
		return getClass().getSimpleName().toUpperCase() + " " + numero + " - Partenza: " + tratta.getPartenza() + " - Arrivo: " + tratta.getCapolinea() + " - Durata media: " + tratta.getTempoPercorrenza() + " minuti.";
	}
