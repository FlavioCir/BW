...
public class Gestionale {
	...
	public static void addMezzi() {
		...
		Autobus a1 = new Autobus(80, TipoMezzo.AUTOBUS, true, "780", TappeAutobus.STAZIONE_TERMINI, TappeAutobus.CASTEL_SANT_ANGELO);
		...
		Autobus a4 = new Autobus(80, TipoMezzo.AUTOBUS, true, "720", TappeAutobus.STAZIONE_TIBURTINA, TappeAutobus.QUIRINALE);
		saveAutobus(a1);
		saveAutobus(a2);
		saveAutobus(a3);
		saveAutobus(a4);
		
		Tram t1 = new Tram(100, TipoMezzo.TRAM, false, "2", TappeTram.STAZIONE_TERMINI, TappeTram.MINISTERO_PUBBLICA_ISTRUZIONE);
		Tram t2 = new Tram(100, TipoMezzo.TRAM, true, "5", TappeTram.COLLI_PORTUENSI, TappeTram.PONTE_BIANCO);
		Tram t3 = new Tram(100, TipoMezzo.TRAM, true, "14", TappeTram.STAZIONE_TIBURTINA, TappeTram.STAZIONE_TRASTEVERE);
